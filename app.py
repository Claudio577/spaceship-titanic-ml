...
st.markdown(
    """
    Aplicação de **Machine Learning** para prever se um passageiro foi
    transportado após uma anomalia espaço-temporal.
    """
)
...
roomservice = st.number_input("Gastos com Room Service", 0.0, 10000.0, 0.0)
foodcourt = st.number_input("Gastos com Food Court", 0.0, 10000.0, 0.0)
shoppingmall = st.number_input("Gastos com Shopping Mall", 0.0, 10000.0, 0.0)
spa = st.number_input("Gastos com Spa", 0.0, 10000.0, 0.0)
vrdeck = st.number_input("Gastos com VR Deck", 0.0, 10000.0, 0.0)
